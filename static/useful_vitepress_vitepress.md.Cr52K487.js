...
<span class="line"><span>    // ...</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>\`\`\`</span></span></code></pre></div><h2 id="高亮代码块中的若干行" tabindex="-1">高亮代码块中的若干行 <a class="header-anchor" href="#高亮代码块中的若干行" aria-label="Permalink to &quot;高亮代码块中的若干行&quot;">​</a></h2><p>在编程别名后面写一个花括号，再在里面写上高亮的行数。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>\`\`\`js{4} // [!code hl]</span></span>
<span class="line"><span>export default {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">template</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div>`,77)]))}const g=a(e,[["render",l]]);export{k as __pageData,g as default};
