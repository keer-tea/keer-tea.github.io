...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 然后我们点到 initState 方法里面，可以看到 Vue 初始化用户传入配置项的顺序依次为 props、methods、data、computed、watch。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 然后有个初始化 data 的方法，名叫 initData，在 initData 里面，会判断 data 的值是一个对象还是一个函数返回一个对象。data 的属性名是不是和 props、methods 重复。最后会将 data 转换为响应式数据。</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">怎么才能进大厂。</span></span></code></pre></div>`,27)])}var c=i(o,[[`render`,s]]);export{a as __pageData,c as default};