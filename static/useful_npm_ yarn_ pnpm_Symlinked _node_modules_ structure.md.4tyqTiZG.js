import{_ as n,c as a,o as e,aK as p}from"./chunks/framework.gpVTZwhR.js";const m=JSON.parse('{"title":"Symlinked node_modules structure","description":"","frontmatter":{"label":"npm"},"headers":[{"level":2,"title":"node_modules 的符号链接结构","slug":"node-modules-的符号链接结构","link":"#node-modules-的符号链接结构","children":[]}],"relativePath":"useful/npm, yarn, pnpm/Symlinked `node_modules` structure.md","filePath":"useful/npm, yarn, pnpm/Symlinked `node_modules` structure.md","lastUpdated":1709816942000}'),o={name:"useful/npm, yarn, pnpm/Symlinked `node_modules` structure.md"};function l(d,s,t,i,r,c){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="symlinked-node-modules-structure" tabindex="-1">Symlinked <code>node_modules</code> structure <a class="header-anchor" href="#symlinked-node-modules-structure" aria-label="Permalink to &quot;Symlinked \`node_modules\` structure&quot;">​</a></h1><p>原文链接：<a href="https://pnpm.io/symlinked-node-modules-structure" target="_blank" rel="noreferrer">https://pnpm.io/symlinked-node-modules-structure</a></p><h2 id="node-modules-的符号链接结构" tabindex="-1">node_modules 的符号链接结构 <a class="header-anchor" href="#node-modules-的符号链接结构" aria-label="Permalink to &quot;node_modules 的符号链接结构&quot;">​</a></h2><blockquote><p>这篇文章仅仅描述没有 peer dependencies 的 pnpm，是怎么构建 node_modules 结构的。</p></blockquote><p>pnpm 的 node_modules 布局使用符号链接来生成一个嵌套的依赖结构。</p><p>在项目的 node_modules/.pnpm 里，每一个包都指向一个硬链接，指向内容寻址的仓库。让我们看看，假设你安装了 foo@1.0.0，它依赖 bar@1.0.0。pnpm 将会硬链接这两个包到 <code>&lt;store&gt;</code>下，像下面这样：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>node_modules</span></span>
