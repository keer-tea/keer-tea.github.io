import{S as e,U as t,t as n,x as r}from"./chunks/vue.runtime.esm-bundler.CJTU9PXy.js";import{t as i}from"./chunks/plugin-vue_export-helper.BlZgCg_Z.js";n();const a=JSON.parse(`{"title":"简直不要太简单，vue3 setup 语法实现虚拟滚动列表","description":"","frontmatter":{"label":["vue"]},"headers":[],"relativePath":"useful/vue/简直不要太简单，vue3 setup 语法实现虚拟滚动列表.md","filePath":"useful/vue/简直不要太简单，vue3 setup 语法实现虚拟滚动列表.md","lastUpdated":1709816942000}`);var o={name:`useful/vue/简直不要太简单，vue3 setup 语法实现虚拟滚动列表.md`};function s(n,i,a,o,s,c){return t(),r(`div`,null,i[0]||=[e(`<h1 id="简直不要太简单-vue3-setup-语法实现虚拟滚动列表" tabindex="-1">简直不要太简单，vue3 setup 语法实现虚拟滚动列表 <a class="header-anchor" href="#简直不要太简单-vue3-setup-语法实现虚拟滚动列表" aria-label="Permalink to “简直不要太简单，vue3 setup 语法实现虚拟滚动列表”">​</a></h1><p>吃水不忘挖井人，本文受到<a href="https://juejin.cn/post/6966179727329460232" target="_blank" rel="noreferrer">百毒不侵 (三)」结合“康熙选秀”，给大家讲讲“虚拟列表”</a>文章的启发。</p><p>我将原文 vue2 的写法改为了 vue3 setup 语法，并且作了全新易于理解的注释，让咋们能从另一个角度去理解虚拟滚动列表的实现。</p><p>并且将某些错误纠正，复制粘贴进编辑器运行即可出效果。</p><p>我理解的虚拟滚动列表，其实就是在屏幕上渲染那固定的几十条数据。上下滚动屏幕时再动态去计算与以往不同的几十条数据。</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">template</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">style</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div>`,6)])}var c=i(o,[[`render`,s]]);export{a as __pageData,c as default};