import{S as e,U as t,t as n,x as r}from"./chunks/vue.runtime.esm-bundler.CJTU9PXy.js";import{t as i}from"./chunks/plugin-vue_export-helper.BlZgCg_Z.js";n();const a=JSON.parse(`{"title":"uni.authorize、uni.getSetting、uni.openSetting 区别和选择使用","description":"","frontmatter":{"label":"uniapp"},"headers":[{"level":2,"title":"问题","slug":"问题","link":"#问题","children":[]},{"level":2,"title":"理解","slug":"理解","link":"#理解","children":[]},{"level":2,"title":"个人结论","slug":"个人结论","link":"#个人结论","children":[]}],"relativePath":"useful/uniapp/uni.authorize、uni.getSetting、uni.openSetting区别和选择使用.md","filePath":"useful/uniapp/uni.authorize、uni.getSetting、uni.openSetting区别和选择使用.md","lastUpdated":1709816942000}`);var o={name:`useful/uniapp/uni.authorize、uni.getSetting、uni.openSetting区别和选择使用.md`};function s(n,i,a,o,s,c){return t(),r(`div`,null,i[0]||=[e(`<h1 id="uni-authorize、uni-getsetting、uni-opensetting-区别和选择使用" tabindex="-1">uni.authorize、uni.getSetting、uni.openSetting 区别和选择使用 <a class="header-anchor" href="#uni-authorize、uni-getsetting、uni-opensetting-区别和选择使用" aria-label="Permalink to “uni.authorize、uni.getSetting、uni.openSetting 区别和选择使用”">​</a></h1><h2 id="问题" tabindex="-1">问题 <a class="header-anchor" href="#问题" aria-label="Permalink to “问题”">​</a></h2><p>我一直对 uni.authorize、uni.getSetting、uni.openSetting 的使用感到纠结。</p><p>以获取位置授权为例，</p><p>大多数人判断用户是否授权都是先使用 getSetting 判断用户已授权的列表，</p><pre><code>如果需要授权的那一项为true可以直接使用uni.getLocation获取用户位置信息；
...
</code></pre><p>我就感觉这里有点多余，直接使用 uni.authorize 或者 uni.getSetting 判断是否授权，然后是否需要使用 uni.openSetting 就好了，为什么要判断两次呢？</p><h2 id="理解" tabindex="-1">理解 <a class="header-anchor" href="#理解" aria-label="Permalink to “理解”">​</a></h2><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uni.authorize</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   },</span></span></code></pre></div><h2 id="个人结论" tabindex="-1">个人结论 <a class="header-anchor" href="#个人结论" aria-label="Permalink to “个人结论”">​</a></h2><p>最后我个人认为如果某个功能必须要用户打开某个权限，直接使用 uni.authorize 即可。</p><p>uni.getSetting 也行，只不过多一次判断。然后再根据业务需求使用 uni.openSetting 让用户打开某项设置权限即可。</p><p>最后最后，如果大佬觉得我的理解是错了，请评论帮我纠正一下，多谢！</p>`,13)])}var c=i(o,[[`render`,s]]);export{a as __pageData,c as default};